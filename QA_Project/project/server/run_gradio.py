...
LLM_MODEL_DICT = {
    ...
    "xinhuo": ["Spark-1.5", "Spark-3.0"],
    "zhipuai": ["glm-4", "glm-4v", "glm-3-turbo"]
}


LLM_MODEL_LIST = sum(list(LLM_MODEL_DICT.values()),[])
INIT_LLM = "ERNIE-Bot-4"
EMBEDDING_MODEL_LIST = ['zhipuai', 'wenxin', 'm3e']
INIT_EMBEDDING_MODEL = "wenxin"
DEFAULT_DB_PATH = "../../data_base/knowledge_db"
DEFAULT_PERSIST_PATH = "../database/vector_wenxin_db"
AIGC_AVATAR_PATH = "project-logo.png"
ALEI_AVATAR_PATH = "aleiya-logo.png"
AIGC_LOGO_PATH = "../server/project-logo.png"
ALEI_LOGO_PATH = "../server/aleiya-logo.png"
...
class Model_center():
    ...
    def chat_qa_chain_self_answer(self, question: str, chat_history: list = [], 
                                  model: str = "ENRIE-Bot-4", embedding: str = "wenxin", 
    ...
    def qa_chain_self_answer(self, question: str, chat_history: list = [],
                             model: str = "ENRIE-Bot-4", embedding="wenxin", 
                             temperature: float = 0.1, top_k: int = 4, 
...
with block as demo:
    with gr.Row(equal_height=True): 
        gr.Image(value=AIGC_LOGO_PATH, scale=1, min_width=35, show_label=False, show_download_button=False, container=False)
          
        with gr.Column(scale=8):
            gr.Markdown("""  """)
            gr.Markdown("""<div align='left' style="vertical-align:middle;"><font size='80'><b>知识库问答助手</b></font></div>
               <div style="vertical-align:middle;">LLM-UNIVERSE</div>
              """)
        

    with gr.Row():
        with gr.Column(scale=4):
            chatbot = gr.Chatbot(height=400, show_copy_button=True, show_share_button=True, avatar_images=(ALEI_AVATAR_PATH, AIGC_AVATAR_PATH))
...
# 直接启动
# demo.launch(server_name="192.168.1.178")
