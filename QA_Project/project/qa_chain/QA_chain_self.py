...
class QA_chain_self():
    ...
    - embedding_key：使用的embedding模型的秘钥（智谱或者百度）
    ...
    def __init__(self, model:str, temperature:float=0.1, top_k:int=4,  
                 file_path:str=None, persist_path:str=None, appid:str=None, 
                 api_key:str=None, Spark_api_secret:str=None,Wenxin_secret_key:str=None, 
                 embedding = "wenxin",  embedding_key = None, template=default_template_rq):
        self.model = model
