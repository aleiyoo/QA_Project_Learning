...
class Ws_Param(object):
    ...
    def create_url(self):
        ...
        authorization_origin = f'api_key="{self.APIKey}", algorithm="hmac-sha256", headers="host date ' \
